...
var AGENTS = {
  ...
  'bi-engineer':            { color: '#E91E63', label: 'BI Engineer',                 desc: 'Streamlit, Plotly Dash, dashboards, chart design',               type: 'specialist',   category: 'mlai', keywords: ['dashboard', 'chart', 'visualization', 'streamlit', 'plotly', 'dash', 'report', 'altair', 'graph', 'visual'] },
