...
var commandRegistry = [
  ...
  { label: 'Open Developer Guide', shortcut: '', action: function() { openGuidePanel(); }, category: 'View' },
  ...
  { label: 'Go to Definition', shortcut: 'F12', action: function() { triggerGoToDefinition(); }, category: 'Editor' },
  { label: 'Peek Definition', shortcut: 'Cmd+Shift+F12', action: function() { triggerPeekDefinition(); }, category: 'Editor' },
  { label: 'Find All References', shortcut: 'Shift+F12', action: function() { triggerFindReferences(); }, category: 'Editor' },
  { label: 'Go to Symbol', shortcut: 'Cmd+Shift+O', action: function() { openSymbolSearch(); }, category: 'Navigation' },
