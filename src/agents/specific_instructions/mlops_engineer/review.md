...
::GATE:: id=specific-instructions-mlops-engineer-review-phase1 phase=1 kind=phase
...
::GATE:: id=specific-instructions-mlops-engineer-review-phase5 phase=5 kind=final
Ask the user:
::ENDGATE::
