...
::GATE:: id=specific-instructions-data-modeller-review-phase1 phase=1 kind=phase
...
::GATE:: id=specific-instructions-data-modeller-review-phase5 phase=5 kind=final
Ask the user:
::ENDGATE::
