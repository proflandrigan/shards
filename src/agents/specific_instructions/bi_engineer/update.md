...
::GATE:: id=bi-engineer-update-phase-1 phase=1 kind=phase
...
::GATE:: id=bi-engineer-update-phase-2 phase=2 kind=phase
...
::GATE:: id=bi-engineer-update-phase-4 phase=4 kind=final
Ask the user:
::ENDGATE::
