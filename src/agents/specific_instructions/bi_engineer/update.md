...
::GATE:: id=specific-instructions-bi-engineer-update-phase1 phase=1 kind=phase
...
::GATE:: id=specific-instructions-bi-engineer-update-phase2 phase=2 kind=phase
...
::GATE:: id=specific-instructions-bi-engineer-update-phase4 phase=4 kind=final
Ask the user:
::ENDGATE::
