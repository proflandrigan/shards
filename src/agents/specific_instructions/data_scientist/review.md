...
::GATE:: id=specific-instructions-data-scientist-review-phase1 phase=1 kind=phase
...
::GATE:: id=specific-instructions-data-scientist-review-phase5 phase=5 kind=final
Ask the user:
::ENDGATE::
